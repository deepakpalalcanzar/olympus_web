...
var db = exports.db = {
	...
	sync: function(callback) {
		...
		// 	force: true
		// } : undefined;
		// // console.log(sequelize.daoFactoryManager.daos)
		// sequelize.sync(opt).success(function() {
		// 	sails.log.verbose("ORM sync successful!");
		// 	callback && callback();
		// });
		callback();
	},
...
Model.extend = function(classObject) {
	...
	if(classObject.tableName) instance.options.tableName = classObject.tableName;
...
Model.prototype.initialize = function(modelName) {
	...
	var m = db.model.define(modelName.toLowerCase(), this.fields, this.options);
	return m;
};
