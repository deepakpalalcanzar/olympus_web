...
serve = function (req, res) {
	sails.log.debug("Ran UploadService.serve() with req.method="+req.method);
	...
	var handleResult = function (result, redirect) {
		sails.log.debug("called handleResult");
		if (redirect) {
			res.writeHead(302, {
...
UploadHandler.prototype.post = function () {
	sails.log.debug("Running POST UploadHandler...");
	...
	redirect,
	finish = function () {
		sails.log.debug("FINISH called in POST UploadHandler.");
		counter -= 1;
		if (!counter) {
	...
	sails.log.debug("uploadDir:",form.uploadDir);
	sails.log.debug("form",form);
	
	form.on('fileBegin', function (name, file) {
		sails.log.debug("FILEBEGIN called in POST UploadHandler.");
		...
		sails.log.debug("FILE called in POST UploadHandler.");
